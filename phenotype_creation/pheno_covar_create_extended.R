...
brain_morph_threshold <- select(intensity_norm, matches("threshold=0.3|ID"))
brain_morph_threshold <- select(brain_morph_threshold, matches("-norm|ID"))
...
#brain_morph_threshold_f_OB <- select(brain_morph_threshold_f, matches("OB|subjectID|ID11867|ID8107"))
#brain_morph_threshold_m_OB <- select(brain_morph_threshold_m, matches("OB|subjectID|ID11867|ID8107"))

#brain_morph_threshold_f$OB_LR-volume.threshold.0.3.warpResolution.2mm <- rowMeans(brain_morph_threshold_f_OB[,c("OB_left.volume.threshold.0.3.warpResolution.2mm","OB_right.volume.threshold.0.3.warpResolution.2mm")], na.rm=TRUE)
brain_morph_threshold_f$`OB_LR-mean_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_f[,c("OB_left-mean_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm","OB_right-mean_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
brain_morph_threshold_f$`OB_LR-median_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_f[,c("OB_left-median_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm", "OB_right-median_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
brain_morph_threshold_f$`OB_LR-max_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_f[,c("OB_left-max_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm", "OB_right-max_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
brain_morph_threshold_f$`OB_LR-90th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_f[,c("OB_left-90th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm", "OB_right-90th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
brain_morph_threshold_f$`OB_LR-95th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_f[,c("OB_left-95th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm", "OB_right-95th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)

#brain_morph_threshold_m$OB_LR.volume.threshold.0.3.warpResolution.2mm <- rowMeans(brain_morph_threshold_m_OB[,c("OB_left.volume.threshold.0.3.warpResolution.2mm","OB_right.volume.threshold.0.3.warpResolution.2mm")], na.rm=TRUE)
brain_morph_threshold_m$`OB_LR-mean_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_m[,c("OB_left-mean_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm","OB_right-mean_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
brain_morph_threshold_m$`OB_LR-median_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_m[,c("OB_left-median_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm", "OB_right-median_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
brain_morph_threshold_m$`OB_LR-max_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_m[,c("OB_left-max_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm", "OB_right-max_intensity-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
brain_morph_threshold_m$`OB_LR-90th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_m[,c("OB_left-90th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm", "OB_right-90th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
brain_morph_threshold_m$`OB_LR-95th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm` <- rowMeans(brain_morph_threshold_m[,c("OB_left-95th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm", "OB_right-95th_percentile-mod=FLAIR-threshold=0.3-warpResolution=2mm-norm")], na.rm=TRUE)
...
brain_morph_threshold_f_long <- brain_morph_threshold_f %>% gather("measure", "value", -c(subjectID,eid_11867))
brain_morph_threshold_m_long <- brain_morph_threshold_m %>% gather("measure", "value", -c(subjectID,eid_11867))
...
brain_morph_threshold_f_wide_resid_norm <- brain_morph_threshold_f_wide_resid_df %>% mutate(across(colnames(brain_morph_threshold_f_wide_resid_df)[grep("*2mm-norm", colnames(brain_morph_threshold_f_wide_resid_df))],invnorm, .names = "{col}_norm"))
brain_morph_threshold_m_wide_resid_norm <- brain_morph_threshold_m_wide_resid_df %>% mutate(across(colnames(brain_morph_threshold_m_wide_resid_df)[grep("*2mm-norm", colnames(brain_morph_threshold_m_wide_resid_df))],invnorm, .names = "{col}_norm"))
...
brain_morph_threshold_resid_norm_PCs_euro_f <- brain_morph_threshold_f_wide_resid_norm_PCs[,grep("*2mm-norm_norm|eid_11867", colnames(brain_morph_threshold_f_wide_resid_norm_PCs))]
...
write.table(brain_morph_threshold_resid_norm_PCs_euro_f_format, "brain_morph_threshold_resid_norm_euro_female_LR_normalised.phe", quote = FALSE, row.names=FALSE)
...
write.table(brain_morph_threshold_resid_norm_PCs_euro_f_covars, "brain_morph_threshold_resid_norm_euro_female_LR_normalised.cov", quote = FALSE, row.names=FALSE)

brain_morph_threshold_resid_norm_PCs_euro_m <- brain_morph_threshold_m_wide_resid_norm_PCs[,grep("*2mm-norm_norm|eid_11867", colnames(brain_morph_threshold_m_wide_resid_norm_PCs))]
...
write.table(brain_morph_threshold_resid_norm_PCs_euro_m_format, "brain_morph_threshold_resid_norm_euro_male_LR_normalised.phe", quote = FALSE, row.names = FALSE)
...
write.table(brain_morph_threshold_resid_norm_PCs_euro_m_covars, "brain_morph_threshold_resid_norm_euro_male_LR_normalised.cov", quote = FALSE, row.names = FALSE)
...
write.table(brain_morph_threshold_resid_norm_PCs_euro_all_LR_format, "brain_morph_threshold_resid_norm_euro_all_LR_normalised.phe", quote=FALSE, row.names=FALSE)
...
write.table(brain_morph_threshold_resid_norm_PCs_euro_all_LR_covars, "brain_morph_threshold_resid_norm_euro_all_LR_normalised.cov", quote=FALSE, row.names=FALSE)
